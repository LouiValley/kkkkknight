...
public class MahoutUtils {
    ...
    public static List<RecommendedItem> userCF(DataModel dataModel) throws TasteException {
        ...
        while (iter.hasNext()) {
            ...
            list = recommenderBuilder.buildRecommender(dataModel).recommend(uid, RECOMMENDER_NUM);
            RecommendFactory.showItems(uid, list, true);
        }
        return list;
    }

    public static List<RecommendedItem> itemCF(DataModel dataModel) throws TasteException {
